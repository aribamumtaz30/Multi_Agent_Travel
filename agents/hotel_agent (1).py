...
class HotelAgent:
    ...
    def __call__(self, state):
        ...
        # Use a stronger share of the budget for accommodation.
        # The revision loop will fine-tune the final plan to within $100 of budget.
        target_total = max(
            120.0,
            state["budget"] * 0.45
        )
        ...
        fallback_options = [

            {
                ...
                "why_recommended":
                    "Central location with comfortable facilities and strong use of the available trip budget.",
